...
const cards = [
  { name: "Amir Faisal K", nickname: "Faisal", Position: "CEO Founder", Skill: "Web Developer", Desc: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident, aperiam.", Img: "img/founder.webp" },
    ...
    <div className="flex m-4 md:m-8 flex-col gap-4 md:gap-8 text-gray-200">
      <div className="flex flex-col gap-2 md:gap-4">
        ...
        <span className="text-md md:text-lg lg:text-xl">
          With a proven process and commitment to quality code, we build stable, scalable web applications your customer will love.
        </span>
      </div>
