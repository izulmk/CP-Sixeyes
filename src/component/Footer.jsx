...
const Footer = () => {
  return (
    <div
      className="snap-start  h-screen bg-white flex flex-col"
      data-slide="10"
      id="slide-10"
    >
        ...
        <div className="m-auto flex flex-col w-full md:w-4/6">
          <div className="w-full flex flex-col gap-8">
            ...
            <p className="text-sm md:text-base">
              Tell us what you need, and we will make it work.
            </p>
            <div className="flex flex-col gap-4">
              ...
              <a
                className="contact-button text-white bg-blue-500 hover:bg-blue-700 py-2 px-4 rounded"
                href="mailto:sixeyes991@gmail.com"
                target="_blank"
              >
                Email : sixeyes991@gmail.com
              </a>
              <Link
                className="contact-button text-white bg-red-500 hover:bg-red-700 py-2 px-4 rounded"
                to="/aboutus"
              >
                Our Team
              </Link>
            ...
            <div className="flex flex-col gap-4">
              ...
              <a
                ...
                href="https://maps.app.goo.gl/oNJoep8ay2P11qSK6"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                ...
                href="https://forms.gle/ofoRFJaPvpmpcoVQA"
                target="blank"
              >
                Internship With Us
              </a>
      ...
      <div className="bg-black text-white h-20 mt-10 w-full text-center flex justify-center items-center">
        <span className="text-sm">
          © 2023 Sixeyes Technologies. All rights reserved.
        </span>
      </div>
    </div>
  );
